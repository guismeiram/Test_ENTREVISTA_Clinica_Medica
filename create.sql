...
create table tb_consulta (id int8 not null, especialidade_medica varchar(255), primary key (id));
...
create table tb_medico (id int8 not null, crm varchar(255), idade int4 not null, nome varchar(255), primary key (id));
